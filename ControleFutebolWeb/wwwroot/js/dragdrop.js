...
//        // Inicializa dataset com valores atuais do estilo
...
//                // calcula pelo centro compensando o translate(-50%, -50%)
...
//                console.log("Jogador:", escId,
//                    "X ampliado:", Math.round(x * 100),
//                    "Y ampliado:", Math.round(y * 100));
...
//                //inputX.value = x.toFixed(2).replace('.', ',');
//                inputX.value = Math.round(x * 100); // "7800"
...
//                //inputY.value = y.toFixed(2).replace('.', ',');
