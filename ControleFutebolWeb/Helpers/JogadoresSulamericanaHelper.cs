...
{
    public static class JogadoresSulamericanaHelper
    {
        ...
        public static string NormalizarNome(string nomeTransfermarkt)
        {
            ...
            return _mapaJogadoresNomes.TryGetValue(nome, out var nomeBanco)
                ? nomeBanco
                : nome; // fallback: retorna o próprio nome se não achar
        }

        /// <summary>
        /// Verifica se o nome informado existe no mapa.
        /// </summary>
        public static bool ExisteNoMapa(string nomeTransfermarkt)
        {
            return !string.IsNullOrWhiteSpace(nomeTransfermarkt)
                   && _mapaJogadoresNomes.ContainsKey(nomeTransfermarkt.Trim());
        }
    }
}
