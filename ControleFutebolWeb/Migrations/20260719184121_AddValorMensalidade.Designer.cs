...
namespace ControleFutebolWeb.Migrations
{
    ...
    [Migration("20260719184121_AddValorMensalidade")]
    partial class AddValorMensalidade
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime?>("AcessoPagoAte")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("acessopagoate");
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.CompeticaoFase", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<string>("RoundsPattern")
                        .HasColumnType("text")
                        .HasColumnName("roundspattern");
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.EscalacaoSeta", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.Nota", b =>
                {
                    ...
                    b.HasIndex("UsuarioId", "JogoId", "JogadorId");
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.PagamentoUsuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.Property<DateTime>("PagoAte")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("pagoate");
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.SelecaoCopaUsuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.Transferencia", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ControleFutebolWeb.Models.EscalacaoSeta", b =>
                {
                    b.HasOne("ControleFutebolWeb.Models.Escalacao", "Escalacao")
                        .WithMany("Setas")
